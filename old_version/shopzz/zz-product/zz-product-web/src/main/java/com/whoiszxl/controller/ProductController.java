...
import com.whoiszxl.entity.vo.ProductVO;
...
public class ProductController {
    ...
    public ResponseResult<IPage> search(@RequestBody SearchQuery searchQuery) {
        ...
        if(searchQuery.getPriceSort() != null) {
            if (searchQuery.getPriceSort().equals(PriceSortConstants.ASC)) {
        ...
        IPage<ProductVO> productVOIPage = page.convert(product -> dozerUtils.map(product, ProductVO.class));
        return ResponseResult.buildSuccess(productVOIPage);
    }
}
