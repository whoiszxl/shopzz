...
@TableName("wms_return_product_inbound_order")
@ApiModel(value="ReturnProductInboundOrder对象", description="退货入库订单表")
public class ReturnProductInboundOrder extends AbstractObject implements Serializable {
    ...
    @ApiModelProperty(value = "退货入库单状态，1：编辑中，2：待审核：3：已完成")
    private Integer returnProductInboundOrderStatus;
