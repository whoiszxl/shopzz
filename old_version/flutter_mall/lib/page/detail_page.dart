              ...
              child: ListView(
                ...
                children: <Widget>[
                  ...
                  Padding(
                      ...
                      child: productPriceBar(
                          productDetailModel.productVO.defaultPrice)
                  ),
                  ...
                  Padding(
                    ...
                    child: productSubTitleBar(
                        productDetailModel.productVO.subName),
                  ),
                  ...
                  Padding(
                    ...
                    child: serviceGuarantees(
                        productDetailModel.productVO.serviceGuarantees),
                  ),

                  //销售属性选择框
                  Padding(
                    padding: EdgeInsets.only(top: 15, left: 10, right: 10),
                    child: SaleAttrSelector(productDetailModel.saleAttrGroup,
                        productDetailModel.skus, productDetailModel.productVO, (
                            skuId) {
                          setState(() {
                            currentSkuId = skuId;
                          });
