...
import 'package:zz_flutter_shop/page/widget/common/count_down.dart';
import 'package:zz_flutter_shop/page/widget/common/counter.dart';
...
class OrderConfirmSkuCard extends StatefulWidget {

  /// 构造函数传入的购物车item信息
  final CartItemVO item;


  OrderConfirmSkuCard({Key key, this.item}) : super(key: key);

  @override
  _OrderConfirmSkuCardState createState() => _OrderConfirmSkuCardState();
}

class _OrderConfirmSkuCardState extends State<OrderConfirmSkuCard> {
  ...
  cartHeader() {
    return Row(
      ...
      children: <Widget>[
        ...
        //自营logo
        Container(width: 30, padding: const EdgeInsets.only(right: 4), child: const Image(image: AssetImage('images/ziying.png'), width: 25, height: 20)),
