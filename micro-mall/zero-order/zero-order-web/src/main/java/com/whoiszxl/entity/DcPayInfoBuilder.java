 ...
 * 数字货币支付信息构建器
 */
public class DcPayInfoBuilder {

    /**
     * 数字货币支付信息实体
     */
    private DcPayInfo dcPayInfo = new DcPayInfo();
    ...
    private DcPayInfoBuilder() {}

    public DcPayInfoBuilder init(CreateDcAddressFactory createDcAddressFactory, String dcName) {
     ...
     * @return 实例对象
     */
    public static DcPayInfoBuilder get() {
        return new DcPayInfoBuilder();
    }
     ...
     * @return
     */
    public DcPayInfoBuilder buildBaseData(Order order) {
        this.dcPayInfo.setOrderId(order.getId());
        this.dcPayInfo.setOrderSn(order.getOrderSn());
     ...
     * @return
     */
    public DcPayInfoBuilder initStatus() {
