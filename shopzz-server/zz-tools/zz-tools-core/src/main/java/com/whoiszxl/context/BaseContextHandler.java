...
import com.whoiszxl.utils.NumberHelper;
import com.whoiszxl.utils.StrHelper;
...
public class BaseContextHandler {
    ...
    public static Long getUserId() {
        Object value = get(BaseContextConstants.JWT_KEY_MEMBER_ID);
    ...
    public static void setUserId(Long userId) {
        set(BaseContextConstants.JWT_KEY_MEMBER_ID, userId);
    }
