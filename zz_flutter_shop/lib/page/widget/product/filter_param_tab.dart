    ...
    return Row(
      ...
      children: <Widget>[
        GestureDetector(
          ...
          child: Text('综合', style: TextStyle(fontSize: 14, color: widget.initialSelection == 0 ? ColorManager.main : Colors.black87)),
        ),
        GestureDetector(
          onTap: () {
          ...
          child: Text('销量', style: TextStyle(fontSize: 14, color: widget.initialSelection == 1 ? ColorManager.main : Colors.black87),
          ),
        ),
        GestureDetector(
          onTap: () {
          ...
          child: Row(
            ...
            children: <Widget>[
              Text('价格', style: TextStyle(fontSize: 14,
                color: (widget.initialSelection == 2 || widget.initialSelection == 3) ? ColorManager.main : Colors.black87,
              ),
              ),
              Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: <Widget>[
                  //如果是2和3选主色
                  Icon(Icons.arrow_drop_up, size: 10, color: widget.initialSelection == 2 ? ColorManager.main : Colors.black87),
                  Icon(Icons.arrow_drop_down, size: 10, color: widget.initialSelection == 3 ? ColorManager.main : Colors.black87),
                ],
              ),
            ],
          ),
        ...
        GestureDetector(
          ...
          child: Text('筛选', style: TextStyle(fontSize: 14, color: widget.initialSelection == 4 ? ColorManager.main : Colors.black87),
          ),
        ),
