...
import com.whoiszxl.zero.entity.vo.CategoryListTreeVO;
...
public class CategoryController {
    ...
    public Result<CategoryListTreeVO> listTree() {
        ...
        return Result.buildSuccess(new CategoryListTreeVO(categoryVOS));
    }
}
