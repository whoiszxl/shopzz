...
productTitleBar(String title) {
  return RichText(
    text: TextSpan(
      children: [
        const WidgetSpan(
          child: Image(image: AssetImage('assets/images/ziying.png'), width: 25, height: 20),
        ),
      ...
      children: [
        ...
        WidgetSpan(child: Column(
          children: [
            ...
            Row(
              children: [
                Text(type, style: const TextStyle(fontWeight: FontWeight.w600, fontSize: 11, color: ColorManager.main)),
