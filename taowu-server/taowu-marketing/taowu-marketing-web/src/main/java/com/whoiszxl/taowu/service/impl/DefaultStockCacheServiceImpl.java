...
public class DefaultStockCacheServiceImpl implements StockCacheService {
    ...
    static {
        ...
        // 相当于加锁   KEYS[2] ALIGN.... LOCK
        // KEYS[1] cache:item_stock:1 100
    ...
    public StockCache getAvailableStock(Long itemId) {
        ...
        //如果不存在，则从redis中获取
        Object stockQuantityObj = redisUtils.getObj(RedisPrefixConstants.Marketing.CACHE_ITEM_STOCK + itemId);
    ...
    public boolean initItemStock(Long seckillItemId) {
        try {
            ...
            String stockCacheKey = RedisPrefixConstants.Marketing.CACHE_ITEM_STOCK + seckillItemId;
            String stockCacheAlignKey = RedisPrefixConstants.Marketing.CACHE_ITEM_STOCK_ALIGN + seckillItemId;
            List<String> keys = Lists.newArrayList(stockCacheKey, stockCacheAlignKey);
