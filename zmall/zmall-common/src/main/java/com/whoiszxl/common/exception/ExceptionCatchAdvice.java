...
public class ExceptionCatchAdvice {
    ...
    static {
        ...
        //业务级别异常
        builder.put(JwtAuthException.class, Result.fail(101001, "用户验证失败"));

        //系统级别异常
        builder.put(HttpMessageNotReadableException.class, Result.fail(200001, "消息体不可读"));
        builder.put(IllegalArgumentException.class, Result.fail(200002, "参数填写错误"));
        builder.put(HttpRequestMethodNotSupportedException.class, Result.fail(200003, "不支持当前请求方式"));
    }
